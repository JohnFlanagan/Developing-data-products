...
The app takes input from the user for their level happiness and the level of sunshine on a particular day. Using a (not-so-complex!) formula, an integer result for a happiness score is returned. 
